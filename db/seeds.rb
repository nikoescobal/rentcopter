...
copter1 = Helicopter.create!(name: "Copter-X", model:"Z", image:"https://luxcior.com/wp-content/uploads/2021/03/Beverly-Hills-Magazine-luxury-helicopters-for-sale-private-helicopter-EUROCOPTERS-5.jpg", description: "Ultra Luxury Heli. Comes with jacuzzi.", rental_cost:50000, capacity:6, flying_range:350, flying_speed:260, user_id:1)
copter2 = Helicopter.create!(name: "Apache-Y", model:"Z", image:"https://www.wheremilan.com/wp-content/uploads/2017/09/helitaly-1.jpg", description: "Military Escort Heli. Comes with three soldiers.",rental_cost:40000,  capacity:8, flying_range:450, flying_speed:460, user_id:2)
copter3 = Helicopter.create!(name: "Deli-Heli", model:"Z", image:"https://www.beverlyhillsmagazine.com/wp-content/uploads/Beverly-Hills-Magazine-shop-luxury-helicopters-for-sale-private-helicopter-AGUSTA-3.jpg", description: "Get your deli meats with Deli-heli. Comes with charcuterie and gelato.",rental_cost:40000,  capacity:10, flying_range:360, flying_speed:250, user_id:3)
copter4 = Helicopter.create!(name: "Airstriker", model:"Z", image:"https://www.xluxuo.com/wp-content/uploads/2020/10/Hill-Helicopters-HX50-1-scaled-1.jpg", description: "Airstrikes on demand. Comes with a desired hitman of choice to finish off remaining targets.",rental_cost:100000, capacity:12, flying_range:750, flying_speed:560,  user_id:4)
