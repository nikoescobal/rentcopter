...
const LogIn = () => {
  ...
  return (
    <div className="h-screen w-screen">
      <div id="main" className="opacity-0 block p-6 rounded-lg shadow-lg bg-white w-3/4 md:w-1/2 lg:w-1/3 h-auto m-auto mt-48 transition-all duration-1000 -translate-y-full">
